package com.weimin.demo4.myBeanFactoryPostProcessor;
...
public class BeanAnnotationBeanFactoryPostProcessor implements BeanFactoryPostProcessor {
    ...
    public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
        try {
            ...
            // 这种方式不走类加载，效率比反射高
            MetadataReader metadataReader = cachingMetadataReaderFactory.getMetadataReader(new ClassPathResource("com/weimin/demo4/DIYConfig.class"));
            ...
            for (MethodMetadata annotatedMethod : annotatedMethods) {
                ...
                beanDefinitionBuilder.setFactoryMethodOnBean(annotatedMethod.getMethodName(),"DIYConfig");
